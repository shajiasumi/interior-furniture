    ...
    t.MixItUp = function() {
        ...
        _refresh: function(t, a) {
            ...
            for (var n = 0; n < i._$targets.length; n++) {
                if ((_ = i._$targets[n]).dataset === e || a) {
                    _.dataset = {};
                    for (var r = 0; r < _.attributes.length; r++) {
                        var o = _.attributes[r],
                            s = o.name,
                            l = o.value;
                        if (s.indexOf("data-") > -1) {
                            var c = i._helpers._camelCase(s.substring(5, s.length));
                            _.dataset[c] = l
                        }
                    }
                }
                _.mixParent === e && (_.mixParent = i._id)
            }
            if (i._$targets.length && t || !i._origOrder.length && i._$targets.length) {
                i._origOrder = [];
                for (n = 0; n < i._$targets.length; n++) {
                    var _ = i._$targets[n];
                    i._origOrder.push(_)
                }
            }
        ...
        _buildState: function(t) {
            ...
            }, t ? a._execFilter("_buildState", e) : (a._state = e, void a._execAction("_buildState", 1))
        },
        _goMix: function(t) {
            var e = this,
                a = function() {
        ...
        _prepTargets: function() {
            ...
            for (i = 0; i < e._$pre.length; i++) {
                n = e._$pre[i], r = t(n);
                var o = n.dataset.origPosX - n.dataset.interPosX,
                    s = n.dataset.origPosY - n.dataset.interPosY;
                a = e._getPrefixedCSS("transform", "translate(" + o + "px," + s + "px)");
        ...
        _animateTargets: function() {
            ...
            for (a = 0; a < e._$toHide.length; a++) {
                i = e._$toHide[a], n = t(i), o = e._getDelay(a);
                var _ = {};
                for (l = 0; 2 > l; l++) {
                    _[(c = 0 === l ? c = e._prefix : "") + "transition-delay"] = o + "ms", _[c + "transform"] = e.effects.transformOut, _.opacity = e.effects.opacity
                }
        ...
        _getPrefixedCSS: function(t, e, a) {
            var i = {},
                n = "",
                r = -1;
            for (r = 0; 2 > r; r++) n = 0 === r ? this._prefix : "", i[n + t] = a ? n + e : e;
        ...
        _parseInsertArgs: function(e) {
            for (var a = {
                ...
                var n = e[i];
                "number" == typeof n ? a.index = n : "object" == typeof n && n instanceof t ? a.$object = n : "object" == typeof n && this._helpers._isElement(n) ? a.$object = t(n) : "object" == typeof n && null !== n ? a.multiMix = n : "boolean" != typeof n || n ? "function" == typeof n && (a.callback = n) : a.multiMix = !1
            }
            return this._execFilter("_parseInsertArgs", a, arguments)
        },
        ...
        getOption: function(t) {
            return t ? this._execFilter("getOption", function(t, a) {
        ...
        return a = this.each(function() {
            if (i && "string" == typeof i[0]) {
                ...
                if ("isLoaded" === i[0]) n.push(!!a);
                    ...
                    var r = a[i[0]](i[1], i[2], i[3]);
                    r !== e && n.push(r)
                }
            } else ! function(e, a) {
                var i = new t.MixItUp;
                i._execAction("_instantiate", 0, arguments), e.id = e.id ? e.id : "MixItUp" + ("00000" + (16777216 * Math.random() << 0).toString(16)).substr(-6).toUpperCase(), i._instances[e.id] || (i._instances[e.id] = i, i._init(e, a)), i._execAction("_instantiate", 1, arguments)
            }(this, i[0])
                ...
                for (var s = 0; 4 > s; s++) {
                    switch (s) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            l = t.MixItUp.prototype._helpers._camelCase(i + r[o])
                    }
