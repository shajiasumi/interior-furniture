    ...
    var a = i.is_mobile(),
        ...
        s = function(t) {
            ...
            return e("script").each(function() {
                ...
                t && t.match(i) && (a = t)
            }), a = a.replace("jquery_revolution.min.js", ""), a = a.replace("jquery.themepunch.revolution.js", ""), a = a.split("?")[0]
        },
        l = function(t, i) {
            var a = 9999,
                n = 0,
